export default[
    {
        ...
        aiPrompt: 'Give Me 5blog idea in bullet wise only on give niche and outline topic and give me result in Rich text editor format ',
        slug:'generate-blog-title',
        form:[
            {
                label:'Enter your blog niches',
                field: 'input',
                name: 'niche',
                required:true
            },{
